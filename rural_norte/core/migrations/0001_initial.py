# Generated by Django 2.0.5 on 2018-07-26 13:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trabalho_fora_lote_quantidade_dias_ano', models.IntegerField(verbose_name='Quantidade de dias/ano trabalha fora do lote')),
                ('trabalho_fora_lote_valor_diaria', models.DecimalField(decimal_places=2, max_digits=7, verbose_name='Valor da Diária (R$/dia)')),
                ...
                ('opcao_ensino_utilizada_distancia_ate_escola', models.IntegerField(verbose_name='Distância até a escola (Km)')),
                ('opcao_ensino_utilizada_oferta_de_transporte', models.IntegerField(choices=[(1, 'Sim'), (0, 'Não')], verbose_name='Há oferta de transporte para a escola?')),
            ],
            options={
                'abstract': False,
            },
